...
public class JokesApiService {
    ...
    public Iterable<Joke> findByType(List<String> type){
        return repository.findByTypeIn(type);
    }

    public Iterable<Joke> findByLang(List<String> lang){
        return repository.findByLangIn(lang);
    }
